...
public final class AmountFormatQueryBuilder extends AbstractQueryBuilder<AmountFormatQueryBuilder, AmountFormatQuery> {
    ...
    /**
     * Creates a new {@link javax.money.format.AmountFormatQueryBuilder}.
     *
    ...
    /**
     * Creates a new default {@link javax.money.format.AmountFormatQueryBuilder} for a formatter based on the
     * locale specific
     * defaults.
     *
    ...
    /**
     * Creates a new {@link javax.money.format.AmountFormatQueryBuilder} and initializes it with the values from {@code formatQuery.
     *
