...
public final class ConversionQuery extends AbstractQuery implements CurrencySupplier {
    ...
    /**
     * Get the base currency. This attribute is optional, when a {@link CurrencyConversion}
     * is accessed. It is optional if accessing instances of {@link ExchangeRateProvider}. If set
     * it can constraint
     * a {@link CurrencyConversion} or {@link ExchangeRateProvider} to
    ...
    /**
     * Get the terminating currency. This attribute is required, when a {@link CurrencyConversion}
     * is accessed. It is optional if accessing instances of {@link ExchangeRateProvider}.
     *
