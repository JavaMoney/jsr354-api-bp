...
/**
 * This enumeration defines the different type of rates that can be provided by {@link org.javamoney.bp.convert
 * .ExchangeRateProvider} implementations. Hereby the rate provider's {@link ProviderContext} can
 * contain
 * additional information about the rates provided. Similarly, when accessing {@link org.javamoney.bp.convert
