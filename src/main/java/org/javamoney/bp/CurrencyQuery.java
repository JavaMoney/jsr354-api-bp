 ...
 * </ul>
 * The effective attributes supported are only determined by the implementations of {@link org.javamoney.bp.spi
 * .CurrencyProviderSpi}.
 * <p>
...
public final class CurrencyQuery extends AbstractQuery implements Serializable {
     ...
     *
     * @param builder the corresponding {@link CurrencyQueryBuilder}, not null.
     */
