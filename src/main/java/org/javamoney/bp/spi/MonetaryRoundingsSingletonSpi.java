...
public interface MonetaryRoundingsSingletonSpi {
     ...
     * @see org.javamoney.bp.RoundingQueryBuilder
     */
    List<String> getDefaultProviderChain();

    /**
     * Execute a query for {@link org.javamoney.bp.MonetaryRounding}. This allows to model more complex used cases,
    ...
    /**
     * Creates a {@link MonetaryRounding} that can be added as {@link org.javamoney.bp.MonetaryOperator} to
     * chained calculations. The instance must lookup the concrete
     * {@link org.javamoney.bp.MonetaryRounding} instance from the {@link org.javamoney.bp.spi.MonetaryRoundingsSingletonSpi}
     * based on the input {@link org.javamoney.bp.MonetaryAmount}'s {@link org.javamoney.bp.CurrencyUnit}.
     *
    ...
    /**
     * Checks if a {@link MonetaryRounding} is available given a {@link org.javamoney.bp.CurrencyUnit}.
     *
