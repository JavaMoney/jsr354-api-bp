...
public interface MonetaryAmountsSingletonQuerySpi {
    ...
    /**
     * Get the {@link org.javamoney.bp.MonetaryAmountFactory} implementation class, that best matches to cover the given
     * {@link org.javamoney.bp.MonetaryContext}.
     * <p>
     * The evaluation order should consider the following aspects:
     * <ul>
     * <li>If {@link org.javamoney.bp.MonetaryContext#getAmountType()} is explicitly defined, it should be considered.
     * Nevertheless if precision/scale cannot be met, a {@link org.javamoney.bp.MonetaryException} should
     * be thrown.
     ...
     * {@link org.javamoney.bp.MonetaryAmount} implementation candidate should be chosen with highest possible
     * precision.
     ...
     * </ul>
     *
     * @return the {@link org.javamoney.bp.MonetaryAmount} implementation class, that best matches to cover the given
     * {@link org.javamoney.bp.MonetaryContext}, never {@code null}.
     * @throws org.javamoney.bp.MonetaryException if no {@link org.javamoney.bp.MonetaryAmount} implementation class can cover
     *                                       the required
     *                                       {@link org.javamoney.bp.MonetaryContext}.
     */
