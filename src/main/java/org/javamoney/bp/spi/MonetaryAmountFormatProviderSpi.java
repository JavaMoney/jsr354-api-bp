...
public interface MonetaryAmountFormatProviderSpi {
	 ...
	 * 
	 * @param formatQuery
	 *            The {@link org.javamoney.bp.format.AmountFormatContext} to be used.
	 * @return An according {@link MonetaryAmountFormat} instance, or {@code null}, which delegates
	 *         the request to subsequent {@link org.javamoney.bp.spi.MonetaryAmountFormatProviderSpi} instances
	 *         registered.
	 */
