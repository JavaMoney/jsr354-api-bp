...
/**
 * Query for accessing instances of {@link org.javamoney.bp.api.MonetaryRounding}. In general it is determined by the
 ...
 * <li>Accessing default roundings for a {@link org.javamoney.bp.api.CurrencyUnit}. This method should return the most
...
public final class RoundingQuery extends AbstractQuery implements CurrencySupplier {
    ...
    /**
     * Constructor, used from the {@link RoundingQueryBuilder}.
     *
     ...
     * access the {@link org.javamoney.bp.api.MonetaryRounding} instances by passing a name, which most of the time
