...
/**
 * Query for accessing instances of {@link org.javamoney.bp.api.format.MonetaryAmountFormat}. In general it is determined by the
...
public final class AmountFormatQuery extends AbstractQuery {
     ...
     *
     * @param builder the corresponding {@link org.javamoney.bp.api.format.AmountFormatQueryBuilder}, not null.
     */
    ...
    /**
     * Gets the {@link org.javamoney.bp.api.MonetaryAmountFactoryQuery} to be used for accessing {@link  MonetaryAmountFactory}, when amount's are parsed.
     *
    ...
    /**
     * Get a {@link org.javamoney.bp.api.format.AmountFormatQueryBuilder} preinitialized with this context instance.
     *
