...
import org.javamoney.bp.api.AbstractQueryBuilder;
...
/**
 * Builder for queries for accessing/configuring {@link org.javamoney.bp.api.format.MonetaryAmountFormat} instances.
 * <p>
...
public final class AmountFormatQueryBuilder extends AbstractQueryBuilder<AmountFormatQueryBuilder, AmountFormatQuery> {
    ...
    /**
     * Creates a new {@link org.javamoney.bp.api.format.AmountFormatQueryBuilder}.
     *
    ...
    /**
     * Creates a new default {@link org.javamoney.bp.api.format.AmountFormatQueryBuilder} for a formatter based on the
     * locale specific
     * defaults.
     *
    ...
    /**
     * Sets the {@link org.javamoney.bp.api.MonetaryContext} to be used, when amount's are parsed.
     *
    ...
    /**
     * Sets the {@link org.javamoney.bp.api.MonetaryAmountFactory} to be used to of amounts during parsing.
     *
     * @param monetaryFactory the {@link org.javamoney.bp.api.MonetaryAmountFactory} to be used, not null.
     * @return this builder for chaining.
     */
    ...
    /**
     * Creates a new {@link org.javamoney.bp.api.format.AmountFormatQuery} instance.
     *
     * @return a new {@link org.javamoney.bp.api.format.AmountFormatQuery} instance, never null.
     */
    ...
    /**
     * Creates a new {@link org.javamoney.bp.api.format.AmountFormatQueryBuilder} and initializes it with the values from {@code formatQuery.
     *
     * @param formatQuery the base {@link AmountFormatContext}, not {@code null}.
     * @return a new {@link org.javamoney.bp.api.format.AmountFormatQueryBuilder} instance, never null.
     */
