...
public interface MonetaryFormatsSingletonSpi {
    ...
    /**
     * Access all {@link org.javamoney.bp.api.format.MonetaryAmountFormat} instances matching the given {@link org.javamoney.bp.api.format
     * .AmountFormatQuery}.
     *
     * @param formatQuery The format query defining the requirements of the formatters.
     * @return the corresponding {@link org.javamoney.bp.api.format.MonetaryAmountFormat} instances, never null
     */
