...
public interface MonetaryAmountFormatProviderSpi {
	 ...
	 * 
	 * @param formatQuery
	 *            The {@link org.javamoney.bp.api.format.AmountFormatContext} to be used.
	 * @return An according {@link MonetaryAmountFormat} instance, or {@code null}, which delegates
	 *         the request to subsequent {@link org.javamoney.bp.api.spi.MonetaryAmountFormatProviderSpi} instances
	 *         registered.
	 */
