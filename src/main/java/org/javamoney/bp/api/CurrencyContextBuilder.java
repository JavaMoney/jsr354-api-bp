...
public final class CurrencyContextBuilder extends AbstractContextBuilder<CurrencyContextBuilder, CurrencyContext> {
     ...
     * Creates a new builder.
     *
     * @param context the {@link org.javamoney.bp.api.CurrencyContext} to be used for initializing this builder.
     */
    ...
    /**
     * Creates a new instance of {@link org.javamoney.bp.api.CurrencyContext}.
     *
     * @return a new {@link org.javamoney.bp.api.CurrencyContext} instance.
     */
    @Override
     ...
     * @param provider the provider name, creating the corresponding {@link CurrencyUnit} containing
     *                 the final {@link CurrencyContext} created by this builder, not null.
     * @return a new {@link org.javamoney.bp.api.CurrencyContextBuilder} instance, never null.
     */
