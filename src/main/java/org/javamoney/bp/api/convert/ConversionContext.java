 ...
 * <ul>
 * <li>the required {@link org.javamoney.bp.api.convert.RateType}, </li>
...
public final class ConversionContext extends AbstractContext {
    ...
    /**
     * Private constructor, used by {@link org.javamoney.bp.api.convert.ConversionContextBuilder}.
     *
    ...
    /**
     * Simple factory method for {@link org.javamoney.bp.api.convert.ConversionContext}. For more
     * possibilities to initialize a {@link org.javamoney.bp.api.convert.ConversionContext}, please use a
     * {@link org.javamoney.bp.api.convert.ConversionContextBuilder},
     *
     * @param provider the provider name, not {@code null}
     * @param rateType the required rate type.
     * @return a new instance of {@link org.javamoney.bp.api.convert.ConversionContext}
     */
     ...
     * <p>
     * <i>Note:</i> for adding additional attributes use {@link org.javamoney.bp.api.convert.ConversionContextBuilder
    ...
    /**
     * Creates a {@link org.javamoney.bp.api.convert.ConversionContext} for accessing rates of the given
