...
import org.javamoney.bp.api.AbstractQuery;
import org.javamoney.bp.api.CurrencySupplier;
import org.javamoney.bp.api.CurrencyUnit;
import java.util.*;

/**
 * Query for accessing {@link org.javamoney.bp.api.convert.CurrencyConversion} instances. If not properties are set the query
...
public final class ConversionQuery extends AbstractQuery implements CurrencySupplier {
    ...
    /**
     * Get the base currency. This attribute is optional, when a {@link org.javamoney.bp.api.convert.CurrencyConversion}
     * is accessed. It is optional if accessing instances of {@link org.javamoney.bp.api.convert.ExchangeRateProvider}. If set
     * it can constraint
     * a {@link org.javamoney.bp.api.convert.CurrencyConversion} or {@link org.javamoney.bp.api.convert.ExchangeRateProvider} to
    ...
    /**
     * Get the terminating currency. This attribute is required, when a {@link org.javamoney.bp.api.convert.CurrencyConversion}
     * is accessed. It is optional if accessing instances of {@link org.javamoney.bp.api.convert.ExchangeRateProvider}.
     *
