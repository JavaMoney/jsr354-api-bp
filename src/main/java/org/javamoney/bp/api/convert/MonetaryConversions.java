 ...
 * {@link ExchangeRateProvider} and {@link org.javamoney.bp.api.convert.CurrencyConversion} instances.
 * <p>
 ...
 * register an according {@link org.javamoney.bp.api.spi.MonetaryConversionsSingletonSpi} that manages the
 ...
 * to the registered {@link org.javamoney.bp.api.spi.MonetaryConversionsSingletonSpi} SPI, which also is required
 * to be thread-safe.
 *
...
public final class MonetaryConversions{
    ...
    /**
     * Checks if a {@link org.javamoney.bp.api.convert.CurrencyConversion} is available for the given parameters.
     *
     * @param conversionQuery the {@link org.javamoney.bp.api.convert.ConversionQuery}, not null.
     ...
     * Checks if a {@link org.javamoney.bp.api.convert.CurrencyConversion} is available for the given parameters.
     *
     * @param currencyCode The currencoy code, resolbable by {@link org.javamoney.bp.api.MonetaryCurrencies#getCurrency
     *                     (String, String...)}
     * @param providers    Additional providers, for building a provider chain
    ...
    /**
     * Checks if a {@link org.javamoney.bp.api.convert.ExchangeRateProvider} is available for the given parameters.
     *
     * @param conversionQuery the {@link org.javamoney.bp.api.convert.ConversionQuery}, not null.
