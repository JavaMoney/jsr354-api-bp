 ...
 * The spi implementation creates new instances of {@link org.javamoney.bp.format.MonetaryAmountFormat} based on the
...
public interface MonetaryAmountFormat extends MonetaryQuery<String> {
    ...
    /**
     * The {@link AmountFormatContext} to be applied when a {@link org.javamoney.bp.MonetaryAmount} is formatted.
     *
     ...
     * {@link org.javamoney.bp.MonetaryContext} applied to the {@link org.javamoney.bp.format.MonetaryAmountFormat}.
     * This formatter will call
     * {@link org.javamoney.bp.MonetaryAmounts#getDefaultAmountType()} and will use the result returned
     * to access a corresponding {@link org.javamoney.bp.MonetaryAmountFactory} to of the instance
     * returned.
     *
