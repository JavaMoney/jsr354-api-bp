...
public final class MonetaryFormats {
    ...
    /**
     * Checks if a {@link MonetaryAmountFormat} is available for the given {@link org.javamoney.bp.format.AmountFormatQuery}.
     *
    ...
    /**
     * This class models the singleton accessor for {@link org.javamoney.bp.format.MonetaryAmountFormat} instances.
     * <p>
     * This class is thread-safe.
     *
     * @author Anatole Tresch
    ...
    public static final class DefaultMonetaryFormatsSingletonSpi implements MonetaryFormatsSingletonSpi {
        ...
        /**
         * Get all available locales. This equals to {@link org.javamoney.bp.spi
