...
/**
 * Query for accessing instances of {@link org.javamoney.bp.format.MonetaryAmountFormat}. In general it is determined by the
...
public final class AmountFormatQuery extends AbstractQuery {
     ...
     *
     * @param builder the corresponding {@link org.javamoney.bp.format.AmountFormatQueryBuilder}, not null.
     */
    ...
    /**
     * Get a {@link org.javamoney.bp.format.AmountFormatQueryBuilder} preinitialized with this context instance.
     *
